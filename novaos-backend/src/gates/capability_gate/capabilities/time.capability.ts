// ═══════════════════════════════════════════════════════════════════════════════
// TIME CAPABILITY
// Fetches current time for a timezone
// ═══════════════════════════════════════════════════════════════════════════════
...
export async function execute(userMessage: string): Promise<EvidenceItem | null> {
  ...
  if (!provider) {
    console.log('[TIME] No time provider available');
    return null;
  }

  if (!provider.isAvailable()) {
    console.log('[TIME] Provider not available');
    return null;
  }
  ...
  try {
    ...
    if (!result.ok) {
      console.log('[TIME] Fetch failed:', result.error?.message);
      return null;
    }
