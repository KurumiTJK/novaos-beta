...
const CONTROL_PATTERNS: Array<{ pattern: RegExp; trigger: ControlTrigger }> = [
  // Self-harm / crisis
...
const HARD_VETO_PATTERNS: Array<{ pattern: RegExp; reason: string }> = [
...
const SOFT_VETO_PATTERNS: Array<{ pattern: RegExp; reason: string; stakes: StakesLevel }> = [
  // High financial risk
...
export class ShieldGate {
   ...
   */
  private detectControlTrigger(message: string): ControlTrigger | null {
   ...
   */
  private detectHardVeto(message: string): { reason: string } | null {
   ...
   */
  private detectSoftVeto(message: string): { reason: string; stakes: StakesLevel } | null {
   ...
   */
  private assessRisk(message: string, intent: any): RiskSummary {
    let interventionLevel: InterventionLevel = 'none';
    let stakesLevel: StakesLevel = 'low';
