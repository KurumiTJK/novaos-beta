...
export const CAPABILITY_MATRIX_VERSION = '4.0.0';
export const CONSTRAINTS_VERSION = '4.0.0';
export const VERIFICATION_POLICY_VERSION = '4.0.0';
export const FRESHNESS_POLICY_VERSION = '4.0.0';
...
export type VerificationTrigger = 
  ...
  | 'numeric_claim'
  | 'public_figure_claim'
  | string;  // Allow other string triggers
...
// Response-like object for invariant checking
...
export const REGENERATION_GATES: GateId[] = ['model', 'personality', 'spark'];

export const IMMEDIATE_DOMAINS = ['stock_prices', 'crypto_prices', 'weather', 'breaking_news'];
...
export const HARD_VETO_TRIGGERS = [
  'illegal_content',
  'child_safety',
  'violence_promotion',
...
export const SOFT_VETO_TRIGGERS = [
  'high_financial_risk',
