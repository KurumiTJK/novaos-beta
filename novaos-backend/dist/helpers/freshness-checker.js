...
exports.FRESHNESS_WINDOWS = void 0;
exports.detectDomain = detectDomain;
exports.detectAllDomains = detectAllDomains;
exports.checkFreshness = checkFreshness;
exports.isImmediateDomain = isImmediateDomain;
exports.getImmediateDomains = getImmediateDomains;
exports.FRESHNESS_WINDOWS = {
 ...
 */
function detectAllDomains(message) {
 ...
 */
function checkFreshness(domain, dataTimestamp) {
    const window = exports.FRESHNESS_WINDOWS[domain] || exports.FRESHNESS_WINDOWS.general;
 ...
 */
function isImmediateDomain(domain) {
    const window = exports.FRESHNESS_WINDOWS[domain];
    return window?.immediate ?? false;
}
/**
 * Get list of all immediate domains.
 */
function getImmediateDomains() {
    return Object.entries(exports.FRESHNESS_WINDOWS)
