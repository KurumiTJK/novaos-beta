...
exports.detectActionRecommendation = detectActionRecommendation;
exports.detectPreciseNumbers = detectPreciseNumbers;
exports.validateSemantics = validateSemantics;
exports.detectViolationsWithSemantics = detectViolationsWithSemantics;
// ─────────────────────────────────────────────────────────────────────────────────
 ...
 */
function detectActionRecommendation(text) {
 ...
 */
function detectPreciseNumbers(text) {
    const matches = [];
    // Price patterns
 ...
 */
function validateSemantics(text, constraints) {
    const violations = [];
    const matchedPatterns = [];
 ...
 */
function detectViolationsWithSemantics(text, constraints) {
    const violations = [];
    // ─────────────────────────────────────────────────────────────────────────
