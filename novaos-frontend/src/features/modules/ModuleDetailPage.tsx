...
import { LearningModule } from './components';
  ...
  return (
    <div className="fixed inset-0 max-w-[430px] mx-auto bg-black flex flex-col z-50">
      ...
      <div className="flex-1 overflow-y-auto p-5">
        {/* Hero */}
        <div className="bg-[#1C1C1E] rounded-3xl p-8 text-center mb-5">
      ...
      >
        <button
          onClick={onClose}
          className="w-full py-4 bg-[#1C1C1E] rounded-2xl text-white font-medium active:bg-[#2C2C2E]"
        >
          Exit
        </button>
      </div>
...
export function ModuleDetailPage() {
  ...
  // Learning module gets special treatment with full hub
  if (activeModule === 'learning') {
    return <LearningModule onClose={handleClose} />;
  }
